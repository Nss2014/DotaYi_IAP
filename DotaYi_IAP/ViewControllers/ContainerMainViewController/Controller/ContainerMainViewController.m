...
@implementation ContainerMainViewController
...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *leftBarBtnItem = [[UIBarButtonItem alloc] initWithTitle:@"点击" style:UIBarButtonItemStylePlain target:self action:@selector(leftBarBtnPressed)];
...
-(void)addTabbarController{
    ...
    TabbarMainViewController *MVC = [[TabbarMainViewController alloc] init];
