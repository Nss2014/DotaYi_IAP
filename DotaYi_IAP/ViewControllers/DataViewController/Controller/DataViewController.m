...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row * COUNTPERCELL <= self.gridDataArray.count - 1)
    {
        ...
        cell.MG_firstItemView.grid_ImageView.image = [UIImage imageNamed:@"hero_data_icon"];
    ...
    if (indexPath.row * COUNTPERCELL + 1 < self.gridDataArray.count)
    {
        ...
        cell.MG_secondItemView.grid_ImageView.image = [UIImage imageNamed:@"odds_data_icon"];
    ...
    if (indexPath.row * COUNTPERCELL + 2 < self.gridDataArray.count + 1)
    {
        ...
        cell.MG_thirdItemView.grid_ImageView.image = [UIImage imageNamed:@"rank_data_icon"];
