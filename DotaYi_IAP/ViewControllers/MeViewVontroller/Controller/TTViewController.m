...
-(void) getTrendAndHeroData
{
    ...
    NSString *body = [NSString stringWithFormat:@"method=ladderheros&u=%@&t=10001",[Tools strForKey:LOGIN_RESPONSE_USERID]];
