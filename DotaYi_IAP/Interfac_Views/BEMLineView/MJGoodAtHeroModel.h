...
@property (nonatomic,copy) NSString *resv8;

@property (nonatomic,copy) NSString *resv5;

@property (nonatomic,copy) NSString *resv7;

@property (nonatomic,copy) NSString *resv9;

@property (nonatomic,copy) NSString *resv10;

@property (nonatomic,copy) NSString *roshan;
