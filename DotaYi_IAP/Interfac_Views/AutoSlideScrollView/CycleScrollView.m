...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(pageControlDidChange:)])
    {
        [self.delegate pageControlDidChange:self.currentPageIndex];
...
{
    [self.animationTimer resumeTimerAfterTimeInterval:animationDuration];
}
