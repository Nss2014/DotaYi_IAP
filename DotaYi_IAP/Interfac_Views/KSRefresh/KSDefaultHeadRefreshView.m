...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.titleLabel                 = [[UILabel alloc] initWithFrame:CGRectMake(self.arrowImageView.frame.origin.x + self.arrowImageView.frame.size.width + 10, 0, SCREEN_WIDTH, KSRefreshView_Height)];
