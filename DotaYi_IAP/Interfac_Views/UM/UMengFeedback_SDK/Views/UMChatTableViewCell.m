...
//
//    CGSize labelSize = [Tools getAdaptionSizeWithText:self.messageLabel.text textWidth:215 textFont:[UIFont systemFontOfSize:14.0f]];
////    [self.messageLabel.text sizeWithFont:[UIFont systemFontOfSize:14.0f]
