...
-(void) setChildVC
{
//    SourceManageViewController *table = [[SourceManageViewController alloc] init];
//    
//    GraphicEditorViewController *collectionView = [[GraphicEditorViewController alloc] init];
//    
//    ManageViewController *table1 = [[ManageViewController alloc] init];
//    
...
//    [self.navigationController.navigationBar addConstraint:[NSLayoutConstraint constraintWithItem:self.segmentView attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:self.navigationController.navigationBar attribute:NSLayoutAttributeLeft multiplier:1 constant:0]];
//    [self.navigationController.navigationBar addConstraint:[NSLayoutConstraint constraintWithItem:self.segmentView attribute:NSLayoutAttributeRight relatedBy:NSLayoutRelationEqual toItem:self.navigationController.navigationBar attribute:NSLayoutAttributeRight multiplier:1 constant:0]];
//
//    [self.navigationController.navigationBar addConstraint:[NSLayoutConstraint constraintWithItem:self.segmentView attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.headerView attribute:NSLayoutAttributeBottom multiplier:1 constant:0]];
//    
//    [self.segmentView addConstraint:[NSLayoutConstraint constraintWithItem:self.segmentView attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:0 multiplier:1 constant:self.segmentHeight]];
    ...
    [self.segmentView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.equalTo(ws.navigationController.view.mas_centerX);
        make.top.equalTo(ws.navigationController.view.mas_top).offset(20);
    }];
}
